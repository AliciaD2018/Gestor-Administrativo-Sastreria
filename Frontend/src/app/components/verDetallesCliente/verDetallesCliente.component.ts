...
@Component({
  selector: 'app-verDetallesCliente',
  templateUrl: './verDetallesCliente.component.html',
  styleUrls: ['./verDetallesCliente.component.css']
})
export class VerDetallesClienteComponent implements OnInit {

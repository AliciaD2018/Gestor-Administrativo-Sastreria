...
export class CrearOrdenComponent implements OnInit {
  ...
  orden: OrdenI = {
    IdOrden: '', IdCliente: '', NombreCliente: '', FechaInicio: '',
  ...
  openDialogAbonar(): void {
    ...
    if (parseInt(abono.SaldoAnterior) > 0 || this.prendas.length > 0) {
      ...
      atributos = {
        Titulo: 'Información', Pregunta: "¡Esta orden no cuenta con saldos pendientes!",
  ...
  openDialogAgregarPrenda(): void {
    let prenda: PrendaI = {
      IdPrenda: '', IdOrden: '', NumeroPrenda: '', IdTipoPrenda: '',
